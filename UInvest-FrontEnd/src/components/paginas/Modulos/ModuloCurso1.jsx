            ...
            <ul className="lista-modulos">
                <li>
                    <div className="modulo-link">
                        <div className={`modulo ${activeAccordion === 0 ? 'active' : ''}`} onClick={() => handleAccordionClick(0)}>
                            <h2>Módulo 1</h2>

                        </div>
                        {activeAccordion === 0 && (
                            <div className="modulo-conteudo">
                                <p>Descrição do Módulo 1
                ...
                <li>
                    <div className="modulo-link">
                        <div className={`modulo ${activeAccordion === 1 ? 'active' : ''}`} onClick={() => handleAccordionClick(1)}>
                        <h2>Módulo 2</h2>
                        </div>
                        {activeAccordion === 1 && (
                            <div className="modulo-conteudo">
                ...
                <li>
                    <div className="modulo-link">
                        <div className={`modulo ${activeAccordion === 2 ? 'active' : ''}`} onClick={() => handleAccordionClick(2)}>
                            <h2>Módulo 3</h2>
                        </div>
                        {activeAccordion === 2 && (
                            <div className="modulo-conteudo">
                            ...
                            <p>• Aula 15/18 - ETFs</p>
                            <p>• Aula 16/18 - Investimentos recomendados para o investidor iniciante<p/>
                            <p>• Aula 17/18 - Declaração de Imposto de Renda</p>
                            <p>• Aula 18/18 - Estratégias de investimento e próximos passos</p>
                            </p>
                            <br />
