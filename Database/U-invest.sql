...
DROP TABLE pg_curso CASCADE CONSTRAINTS;
...
Atualiza��o de dados: /*Atualiza os dados da tabela*/
...
UPDATE aula SET conteudo = 'Aula introdut�ria  de programa��o.' WHERE id_aula = 'aula001';
...
Relat�rio utilizando alguma fun��o do tipo num�rica simples /*Coloca em ordem crescente com base na horas da plataforma*/
select * from login order by hrs_plataforma asc;

Relat�rio utilizando alguma fun��o de grupo /*Soma o saldo dos investidores com base no seu perfil de investimento */
SELECT perfil_investidor, SUM(saldo) AS saldo_total FROM usuario GROUP BY perfil_investidor; 

Relat�rio utilizando sub consulta. /*Realiza a media das avali��es dos usurario que utilizaram o tipo de conteudo Video*/
SELECT AVG(avaliacao) AS media_avaliacao_videos FROM aula WHERE tipo_conteudo = 'Video';

Relat�rio utilizando jun��o de tabela    
/*  Jun��o das tabelas
