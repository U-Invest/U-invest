...
insert into usuario (cpf, email, celular, nome, saldo, senha, perfil_investidor) values ('12345678910', 'joao@gmail.com', '99999999999', 'Jo�o Silva', 10000, 'senha123', 'conservador');
...
insert into usuario (cpf, email, celular, nome, saldo, senha, perfil_investidor) values ('89012345678', 'vitoria@outlook.com', '22222222222', 'Vit�ria Pereira', 25000, 'senhaabc', 'moderado');
...
values (10, 8, 'aprenda os fundamentos do javascript', 'jo�o da silva', 'javascript b�sico', 'jsb1', 50);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (15, 9, 'aprenda a construir websites com html e css', 'maria souza', 'html e css essencial', 'htmlec1', 75);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (20, 7, 'aprenda a criar aplica��es web din�micas com php', 'pedro oliveira', 'php para iniciantes', 'phpi1', 100);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (5, 10, 'aprenda a usar ferramentas de an�lise de dados com excel', 'ana santos', 'excel avan�ado', 'exa1', 150);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (30, 8, 'aprenda a desenvolver aplica��es m�veis para android', 'rafael costa', 'android app development', 'aad1', 200);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (25, 6, 'aprenda a programar em python para an�lise de dados', 'juliana fernandes', 'python para an�lise de dados', 'pyad1', 125);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (12, 9, 'aprenda a criar interfaces gr�ficas com javafx', 'lucas mendes', 'javafx para desenvolvedores', 'jfx1', 175);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (8, 7, 'aprenda a criar jogos com a unity', 'felipe santos', 'desenvolvimento de jogos com unity', 'unity1', 100);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (18, 8, 'aprenda a usar o react para criar aplica��es web', 'gabriel almeida', 'react para desenvolvedores web', 'react1', 150);
insert into curso (duracao, avaliacao, resumo, nome_professor, nome, id_curso, recompensa)
values (7, 10, 'aprenda a usar ferramentas de edi��o de v�deo com adobe premiere', 'paulo roberto', 'edi��o de v�deo com adobe premiere', 'prm1', 75);
...
values ('Introdu��o � programa��o', 'mod001', 'Programa��o b�sica');
insert into modulo (resumo, id_modulo, nome)
...
insert into modulo (resumo, id_modulo, nome)
values ('L�gica de programa��o', 'mod004', 'L�gica para iniciantes');
insert into modulo (resumo, id_modulo, nome)
values ('Banco de dados', 'mod005', 'MySQL e SQL Server');
insert into modulo (resumo, id_modulo, nome)
values ('Programa��o orientada a objetos', 'mod006', 'POO com Java');
insert into modulo (resumo, id_modulo, nome)
values ('Desenvolvimento mobile', 'mod007', 'Android Studio');
insert into modulo (resumo, id_modulo, nome)
values ('Programa��o funcional', 'mod008', 'JavaScript avan�ado');
insert into modulo (resumo, id_modulo, nome)
values ('Data Science', 'mod009', 'Introdu��o ao R');
insert into modulo (resumo, id_modulo, nome)
...
values ('Texto', TO_DATE('2022-03-01', 'YYYY-MM-DD'), 'Introdu��o ao curso', 'aula001', 'Apresenta��o do curso', 90);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('V�deo', TO_DATE('2022-03-02', 'YYYY-MM-DD'), 'Conceitos b�sicos', 'aula002', 'O que � programa��o?', 85);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('Texto', TO_DATE('2022-03-03', 'YYYY-MM-DD'), 'Tipos de dados', 'aula003', 'N�meros, texto, datas e booleanos', 80);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('V�deo', TO_DATE('2022-03-04', 'YYYY-MM-DD'), 'Estruturas de controle', 'aula004', 'If, for, while, switch', 75);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('Texto', TO_DATE('2022-03-05', 'YYYY-MM-DD'), 'Fun��es', 'aula005', 'Criando e usando fun��es', 90);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('V�deo', TO_DATE('2022-03-06', 'YYYY-MM-DD'), 'Arrays', 'aula006', 'Trabalhando com listas de valores', 80);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('Texto', TO_DATE('2022-03-07', 'YYYY-MM-DD'), 'Objetos', 'aula007', 'Classes, propriedades e m�todos', 85);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('V�deo', TO_DATE('2022-03-08', 'YYYY-MM-DD'), 'Heran�a', 'aula008', 'Compartilhando comportamentos', 90);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('Texto', TO_DATE('2022-03-09', 'YYYY-MM-DD'), 'Interfaces', 'aula009', 'Contratos e implementa��es', 80);
insert into aula (tipo_conteudo, duracao, nome_aula, id_aula, conteudo, avaliacao)
values ('Texto', TO_DATE('2024-05-09', 'YYYY-MM-DD'), 'Interfaces', 'aula010', 'Interpreta��o da linguagem', 70);
...
values ('Introdu��o � Programa��o', 'Jo�o da Silva', 'Digital Signature Inc.', '30h', TO_DATE('2022-03-05', 'YYYY-MM-DD'), TO_DATE('2022-03-01', 'YYYY-MM-DD'), 'cert001', 'Maria Souza');
insert into certificado 
...
insert into certificado 
values  ('Algoritmos e L�gica de Programa��o', 'Maria Lima', 'DigiCert', '20h', TO_DATE('2022-03-20', 'YYYY-MM-DD'), TO_DATE('2022-03-15', 'YYYY-MM-DD'), 'cert004', 'Jos� Santos');
insert into certificado 
values  ('Java Avan�ado', 'Luiz Silva', 'Entrust Datacard', '80h', TO_DATE('2022-03-25', 'YYYY-MM-DD'), TO_DATE('2022-03-20', 'YYYY-MM-DD'), 'cert005', 'Roberto Oliveira');
insert into certificado 
values  ('PHP B�sico', 'Carla Santos', 'Comodo CA', '30h', TO_DATE('2022-04-01', 'YYYY-MM-DD'), TO_DATE('2022-03-27', 'YYYY-MM-DD'), 'cert006', 'Marcelo Souza');
insert into certificado 
...
insert into certificado 
values  ('C++ Avan�ado', 'Gabriela Almeida', 'Thawte', '60h', TO_DATE('2022-01-28', 'YYYY-MM-DD'), TO_DATE('2022-02-28', 'YYYY-MM-DD'), 'cert008', 'Luciano Santos');
insert into certificado 
values  ('Java para Desenvolvimento Web', 'Aline Silva', 'Entrust Datacard', '50h', TO_DATE('2022-02-28', 'YYYY-MM-DD'), TO_DATE('2022-02-15', 'YYYY-MM-DD'), 'cert009', 'Andr� Souza');
insert into certificado 
values  ('Python Avan�ado', 'Felipe Rodrigues', 'CertSign', '70h', TO_DATE('2022-03-01', 'YYYY-MM-DD'), TO_DATE('2022-02-20', 'YYYY-MM-DD'), 'cert010', 'Pedro Oliveira');

// rela��o entre curso e certificado
CREATE TABLE libera (
